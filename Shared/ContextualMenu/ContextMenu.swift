...
public class ContextMenu: NSObject {
    ...
    public func show(
        ...
        if let raw = options.hapticsStyle?.rawValue, let feedbackStyle = UIImpactFeedbackGenerator.FeedbackStyle(rawValue: raw) {
        ...
        sourceViewController.present(item.viewController, animated: false)
    }
