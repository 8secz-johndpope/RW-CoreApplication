...
//        }
        ...
        containedViewController.navigationBar.isTranslucent = false
        containedViewController.navigationBar.setBackgroundImage(image, for: .any, barMetrics: .default)
        containedViewController.navigationBar.shadowImage = image
